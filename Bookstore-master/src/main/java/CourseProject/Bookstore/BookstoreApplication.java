...
/*		repository.save(new Book(173323373,"Harry Potter and the Philosopher's Stone","J.K.Rowling", 1998, 20,lrepository.findByLibName("Pasila").get(0)));
		repository.save(new Book(635352965,"Alchemist","Paulo Coelho", 1993, 35, lrepository.findByLibName("Malmi").get(0)));*/
